...
def ACL_clusering(seed_user,epsilon):
    ...
    try:
        ...
        if results_starting == ():
            print("Seed Twitter user not found in G_pos dataset.")
        else:
    ...
    # Run the approximate pagerank on the graph G
    alpha = 0.01
    size_factor = 0.7
    ...
    # Compute the sweep set in the graph G
    ...
    return stag.cluster.conductance(g_pos, sweep_set)
