...
print("DROP TABLE IF EXISTS REPLY_STATUS")
...
print('CREATE TABLE REPLY_STATUS')
...
print("DROP TABLE IF EXISTS RETWEET_STATUS")

cursor.execute("DROP TABLE IF EXISTS QUOTED_STATUS")
print("DROP TABLE IF EXISTS QUOTED_STATUS")
...
print('CREATE TABLE RETWEET_STATUS')
...
print('CREATE TABLE QUOTED_STATUS')
